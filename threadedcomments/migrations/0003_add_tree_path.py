...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ThreadedComment.tree_path'
        db.add_column('threadedcomments_comment', 'tree_path', self.gf('django.db.models.fields.TextField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ThreadedComment.tree_path'
        db.delete_column('threadedcomments_comment', 'tree_path')
    ...
    models = {
        ...
        'threadedcomments.threadedcomment': {
            ...
            'tree_path': ('django.db.models.fields.TextField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'})
        }
    }
