...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ThreadedComment.last_child'
        db.add_column('threadedcomments_comment', 'last_child', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['threadedcomments.ThreadedComment'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ThreadedComment.last_child'
        db.delete_column('threadedcomments_comment', 'last_child_id')
